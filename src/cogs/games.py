...
class vein5(commands.Cog, name= "games"):
    ...
    async def rps(self, ctx, msg: str):
        ...
        'It was a good battle, learned alot from you but a tie is a tie', 'Good battle, you didnnot disappoint me.']
        ...
        embed.add_field(name=f"Dh's words:", value=f'"**{final_result}**"',inline=False)
