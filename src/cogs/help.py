...
class vein9(commands.Cog, name='Help'):
    ...
    async def help(self, ctx, *, entity=None):
        ...
        if entity == None:
            ...
            em.add_field(name=f"[Commands/Tags]", value =f"**You can pass in the amount of pictures like, `dh nsfw 10`**\n `nsfw`, `gifs` ,`blowjob`, `anal`, `ass`, `milf` , `kemo`, `oppai`, `glasses`, `panties`, `elves`, `maid`, `bdsm`, `pussy`, `1girl`, `cum`, `uniform`, `public`, `thighs`, `creampie`, `cuckold`, `gangbang`, `boobjob`, `erofeet`, `pantyhose` `stockings`, `bunnygirl`,`hairy`,`femdom`, `fitness`, `monstergirl`, `videos`, `lingerie`, `foreplay`, `handjob`, `masturbation`, `swimsuit`, `wet`, `armpits`, `darkskin` ", inline=False)
